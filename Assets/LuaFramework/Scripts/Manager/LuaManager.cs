...
//                lua.AddSearchPath(rootPath + "/ToLua/Lua");
				if(AppConst.LuaCustomDir != null)
				{
					foreach (string dir in AppConst.LuaCustomDir) 
					{
						string path = Application.dataPath + "/" + dir;
						//Debug.Log ("search lua custom path:"+path);
				...
				if(AppConst.LuaCustomDir != null)
				{
					foreach (string dir in AppConst.LuaCustomDir) 
					{
      //                   string path = Util.DataPath + "lua/" + dir;
						// lua.AddSearchPath(path);
                        string path = Util.DataPath + "lua/" + dir.ToLower();
                        lua.AddSearchPath(path);
                        //Debug.Log ("search lua custom path:"+path);
					}
				}
